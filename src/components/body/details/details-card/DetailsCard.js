...
import Matafuego from '../../../../assets/img/Matafuego.png';
    ...
    <Card>
      <Card.Header>
        ...
        <Card.Subtitle className="mb-2 text-muted">
          Faro Recalada 20, Monte Hermoso, Buenos Aires, Argentina
        </Card.Subtitle>
        <Card.Text>
          Departamento en pleno centro. Tercer piso balcon a la calle con ascensor. Espectacular
          vista panoramica. A pasos de la peatonal Dufaur y 2 de la playa.
        </Card.Text>
      </Card.Header>
      <Card.Body>
      ...
      <Card.Body>
        ...
        <Container>
          ...
          <Row>
            <Col>
              <BoxIconText text="Matafuegos">
                <Image src={Matafuego} width="50" height="50" />
              </BoxIconText>
            </Col>
            <Col />
          </Row>
